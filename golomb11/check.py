#!/usr/bin/env python3
"""Optimal Golomb ruler of order 11: 11 marks, all pairwise distances
distinct, total length exactly 72 (the known optimum).
...
if m[-1]-m[0] != OPT: no("length is %d; the optimal order-11 ruler has length %d" % (m[-1]-m[0], OPT))
yes("optimal Golomb ruler of order 11, length 72")
